      ...
      inject([TestComponentBuilder], (tcb: TestComponentBuilder) => {
        tcb.createAsync(TestComponent)
          .then((rootTC: any) => {
            ...
            expect(getDOM().querySelectorAll(componentDOMEl, 'div')[0].textContent).toEqual('Melody component');
          });
      }));
  });
}
...
@Component({
  selector: 'test-cmp',
  template: '<sd-melody></sd-melody>',
  directives: [MelodyComponent]
})
class TestComponent {}
